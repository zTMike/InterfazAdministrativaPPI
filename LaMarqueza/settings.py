...
STATIC_URL = 'LaMarqueza/static/'

# Directorio donde se almacenarán los archivos estáticos
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'LaMarqueza/static'),
]

# Directorio donde se recopilarán los archivos estáticos cuando se ejecute 'collectstatic'
